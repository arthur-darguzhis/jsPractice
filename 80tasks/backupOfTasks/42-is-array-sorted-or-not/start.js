...
assert.equal(arraySortInfo(a), "Некоторые элементы не являются числами")
assert.equal(arraySortInfo(b), "Массив отсортирован по возрастанию")
assert.equal(arraySortInfo(c), "Массив отсортирован по убыванию")
assert.equal(arraySortInfo(d), "Массив не отсортирован")
