 ...
 *  - Также нужно изменить свойство dimensions объекта
 * и сделать его вычисляемым свойством (вычисляемым значит что содержимое переменной dimensions должно стать ключем в объекте)
 *
