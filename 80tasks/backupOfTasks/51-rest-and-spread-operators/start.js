...
assert.deepEqual(meanScore(...scores1), 1.93);
assert.deepEqual(meanScore(...scores1, ...scores2), 2.8);
assert.deepEqual(meanScore(...scores1, ...scores2, ...scores3), 2.59);
assert.deepEqual(meanScore(...scores4), "Все аргументы в вызове функции должны быть числами!");
